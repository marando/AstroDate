...
class AstroDateTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testJd()
    {
        ...
        foreach ($dates as $d) {
            ...
            $this->assertEquals($toJd->toJD(), $fromJD->toJD(), "from JD $d[0]",
              1e-4);
        }
    }
    ...
    public function testMjd()
    {
        ...
        foreach ($dates as $d) {
            ...
            $this->assertEquals($toMJD->toMJD(), $fromMJD->toMJD(),
              "from MJD $d[0]",
              1e-4);
        }
    }
    ...
    public function testParse()
    {
        $dates = [
          ...
          [
            'Tue, 2015-Nov-16 05:07:07.3 PM UTC',
            2015,
            11,
            16,
            17,
        ...
        foreach ($dates as $d) {
            ...
            $this->assertEquals($d[7], (float)"0.$date->micro",
              $d[0] . ' micro');
    ...
    public function testToJD()
    {
        ...
        foreach ($dates as $d) {
            $fromJD = AstroDate::jd($d[1]);
            $toJd   = AstroDate::parse($d[0]);
            $this->assertEquals($fromJD->toJD(), $toJd->toJD(), "to JD $d[0]",
              1e-4);
        }
    }
    ...
    public function testToMJD()
    {
        ...
        foreach ($dates as $d) {
            $fromMJD = AstroDate::mjd($d[1]);
            $toMJD   = AstroDate::parse($d[0]);
            $this->assertEquals($fromMJD->toMJD(), $toMJD->toMJD(),
              "to MJD $d[0]",
              1e-4);
        }
    }
    ...
    public function testToUTC()
    {
        ...
        foreach ($tests as $t) {
            $this->assertEquals(2456658.5, $t->toUTC()->toJD(), $t->timescale,
              1e-4);
        }
    }
    ...
    public function testToTAI()
    {
        ...
        $this->assertEquals($tai->toJD(), $tt->toTAI()->toJD(), 'TT -> TAI',
          1e-5);

        $ut1 = AstroDate::jd(2453750.5 + 0.892104561, TimeScale::UT1());
        $tai = AstroDate::jd(2453750.5 + 0.892110139, TimeScale::TAI());
        $this->assertEquals($tai->toJD(), $ut1->toTAI()->toJD(), 'UT1 -> TAI',
          1e-3);

        $utc = AstroDate::jd(2453750.5 + 0.892100694, TimeScale::UTC());
        $tai = AstroDate::jd(2453750.5 + 0.892110139, TimeScale::TAI());
        $this->assertEquals($tai->toJD(), $utc->toTAI()->toJD(), 'UTC -> TAI',
          1e-3);
    }
    ...
    public function testToTT()
    {
        ...
        $this->assertEquals($tt->toJD(), $tai->toTT()->toJD(), 'TAI -> TT',
          1e-5);

        $tdb = AstroDate::jd(2453750.5 + 0.892855137, TimeScale::TDB());
        $tt  = AstroDate::jd(2453750.5 + 0.892855139, TimeScale::TT());
        $this->assertEquals($tt->toJD(), $tdb->toTT()->toJD(), 'TDB -> TT',
          1e-8);

        $ut1 = AstroDate::jd(2453750.5 + 0.892104561, TimeScale::UT1());
        $tt  = AstroDate::jd(2453750.5 + 0.892855139, TimeScale::TT());
        $this->assertEquals($tt->toJD(), $ut1->toTT()->toJD(), 'UT1 -> TT',
          1e-5);
    }
    ...
    {
        $tai = AstroDate::jd(2453750.5 + 0.892482639, TimeScale::TAI());
        $ut1 = AstroDate::jd(2453750.5 + 0.8921045614537037037,
          TimeScale::UT1());
        $this->assertEquals($ut1->toJD(), $tai->toUT1()->toJD(), 'TAI -> UT1',
          1e-5);

        $tt  = AstroDate::jd(2453750.5 + 0.892855139, TimeScale::TT());
        $ut1 = AstroDate::jd(2453750.5 + 0.8921045614537037037,
          TimeScale::UT1());
        $this->assertEquals($ut1->toJD(), $tt->toUT1()->toJD(), 'TT -> UT1',
          1e-5);

        $utc = AstroDate::jd(2453750.5 + 0.892100694, TimeScale::UTC());
        $ut1 = AstroDate::jd(2453750.5 + 0.8921045614537037037,
          TimeScale::UT1());
        $this->assertEquals($ut1->toJD(), $utc->toUT1()->toJD(), 'UTC -> UT1',
          1e-5);
    }
    ...
    {
        $tt  = AstroDate::jd(2453750.5 + 0.892855139, TimeScale::TT());
        $tdb = AstroDate::jd(2453750.5 + 0.8928551366736111111,
          TimeScale::TDB());
        $this->assertEquals($tdb->toJD(), $tt->toTDB()->toJD(), 'TT -> TDB',
          1e-8);
    }
    ...
    public function testDayName()
    {
        ...
        foreach ($tests as $dName => $dt) {
            ...
            $this->assertEquals(substr($dName, 0, 3), $dt->dayName(false),
              'abr');
        }
    }
    ...
    public function testSidereal()
    {
        $tests = [
          [
            ...
            AstroDate::mjd(53736.0, TimeScale::UT1())->sidereal('m'),
            1e-9,
          ],
          [
            1.75416613767501915,
            AstroDate::mjd(53736.0, TimeScale::UT1())->sidereal('a'),
            1e-8,
          ],
          [
            1.754174971870091203 + deg2rad(-20),
            AstroDate::mjd(53736.0,
              TimeScale::UT1())->sidereal('m', Angle::deg(-20)),
            1e-9,
          ],
          [
            1.75416613767501915 + deg2rad(-20),
            AstroDate::mjd(53736.0,
              TimeScale::UT1())->sidereal('a', Angle::deg(-20)),
            1e-8,
          ],
        ];
    ...
    public function testSolsticeSummer()
    {
        ...
        foreach ($jun as $s) {
            ...
            $this->assertEquals($expected->toJD(), $equinox->toJD(), $s[0],
              1e-3);
        }
    }
    ...
    public function testEquinoxSpring()
    {
        ...
        foreach ($mar as $e) {
            ...
            $this->assertEquals($expected->toJD(), $equinox->toJD(), $e[0],
              1e-3);
        }
    }
